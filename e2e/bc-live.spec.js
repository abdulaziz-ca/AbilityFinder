...
async function pick(page, text) {
  ...
  // 90s anyway and losing the message. No job cap is raised and retries: 0 is
  // untouched: this is strictly more patient than the unbounded click it replaces
  // and strictly less patient than the 90s test timeout it stops that click from
  // consuming.
  await page
