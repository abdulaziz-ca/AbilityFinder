...
//
// 96 benefits. Figures are redacted on purpose — the assistant is
...
export const BENEFIT_DETAILS = {
  ...
  "home-accessibility-tax-credit": {
    ...
    "text": "What it is: The Home Accessibility Tax Credit is claimed at line 31285 of your federal return. A qualifying individual can claim up to [amount — see the guide] per year in eligible expenses. Where more than one qualifying individual lives in the same dwelling, the total for that dwelling is still [amount — see the guide] and where several people are entitled to claim, they can split it. The annual limit was [amount — see the guide] for 2022 through 2024, and [amount — see the guide] from 2015 through 2021. CRA states that an expense which also qualifies as a medical expense can be claimed both as a medical expense and as a home accessibility expense.\nHow to apply:\n  1. keep every invoice and receipt, showing the vendor, their business address, their GST/HST number where applicable, a description of the work and the address, the amount, and proof of payment\n  2. complete the chart for line 31285 on the Federal Worksheet\n  3. enter the result on line 31285 of your federal return, and keep the documents rather than sending them\nWhat you need:\n  - agreements, invoices and receipts identifying the vendor, the work, the address and the amount\n  - proof of payment\n  - for a condominium or co-operative, a signed statement from the corporation setting out the amounts and your share\nPractical tips:\n  - you do not apply in advance, you claim it when you file\n  - it is non-refundable, so it reduces tax owing rather than paying out on its own\n  - costs that mainly raise the value of the home, routine repairs, appliances and financing costs are not eligible\n  - an item you buy that does not become a permanent part of the home is generally not eligible"
  },
  ...
  "disability-supports-deduction": {
    ...
    "text": "What it is: Line 21500 lets a person with an impairment in physical or mental functions deduct what they paid for supports that made work, school or research possible. Use Form T929, Disability Supports Deduction, to work out the amount, then enter the figure from line 12 of that form on line 21500 of your return, in Step 3, net income. CRA notes that the same medical expense can be claimed on line 21500 or on line 33099, or split between the two, as long as the total claimed is not more than the expense. Do not send Form T929 or the receipts with your return; keep them in case CRA asks.\nHow to apply:\n  1. check the CRA list of eligible expenses for this deduction and whether any of yours need a medical practitioner's certification\n  2. complete Form T929, Disability Supports Deduction\n  3. enter the amount from line 12 of Form T929 on line 21500 of your return, and keep the form and receipts rather than sending them.\nWhat you need:\n  - receipts for every expense claimed\n  - Form T929, Disability Supports Deduction\n  - any certification from a medical practitioner that a particular expense requires.\nPractical tips:\n  - only the person with the disability can claim this, so it cannot be moved to a parent or spouse\n  - decide whether each expense is better on line 21500 or as a medical expense on line 33099, because you can split them but not double-count\n  - because it is a deduction it reduces taxable income, which can matter more than a credit at higher incomes."
  },
  "medical-expense-tax-credit": {
    ...
    "text": "What it is: For line 33099 you total the eligible expenses, then subtract the lesser of [percentage — see the guide] of your net income from line 23600 or [amount — see the guide] and the remainder is what the credit is calculated on. CRA's own worked example: Pauline's net income is [amount — see the guide] [percentage — see the guide] of that is [amount — see the guide] and because [amount — see the guide] is less than [amount — see the guide] she subtracts [amount — see the guide] from the [amount — see the guide] of combined expenses. Expenses for children [age limit — see the guide] can be combined with the parents' expenses. For a dependant other than a spouse, partner or child [age limit — see the guide], use line 33199 and run the same lesser-of calculation against that dependant's own net income. The [amount — see the guide] figure is indexed and changes by tax year.\nHow to apply:\n  1. collect receipts for every eligible medical expense for the year, for yourself, your spouse or partner and your children [age limit — see the guide]\n  2. total them and subtract the lesser of [percentage — see the guide] of your net income from line 23600 or [amount — see the guide]\n  3. enter the result on line 33099\n  4. claim expenses for any other dependant separately on line 33199, running the same calculation against that dependant's net income.\nWhat you need:\n  - receipts for every medical expense claimed\n  - prescriptions or practitioner certifications where CRA requires them\n  - your net income figure from line 23600.\nPractical tips:\n  - the threshold is the LESSER of the two figures, so a lower income means a lower threshold and more of your expenses count\n  - you can pick the 12-month period ending in the tax year that captures the most expenses, so check CRA's rule before choosing\n  - if you also claim the disability supports deduction on line 21500, split each expense between the two rather than claiming it twice\n  - the [amount — see the guide] threshold is indexed, so confirm the current figure for your filing year."
  },
  "canada-caregiver-credit": {
    ...
    "text": "What it is: The Canada caregiver credit is a non-refundable credit for people supporting a family member with a mental or physical impairment. As CRA currently publishes it: for a spouse or common-law partner you may claim [amount — see the guide] on line 30300 and up to [amount — see the guide] on line 30425. For an eligible dependant [age limit — see the guide] or older who qualifies for line 30400, you may claim [amount — see the guide] on line 30400 and up to [amount — see the guide] on line 30425. For an eligible dependant [age limit — see the guide] who qualifies for line 30400, you may claim [amount — see the guide] on either line 30400 or line 30500. For each of your own or your spouse's or partner's children [age limit — see the guide] at the end of the year, you may claim [amount — see the guide] on line 30500. For each dependant [age limit — see the guide] or older who is not your spouse or partner and is not an eligible dependant claimed on line 30300 or line 30400, you may claim up to [amount — see the guide] on line 30450. All of these amounts are indexed and change by tax year.\nHow to apply:\n  1. work out your relationship to the person you support and whether they have a mental or physical impairment\n  2. check which line applies to that relationship, and whether any other credit is already being claimed for them\n  3. claim the amount on the correct line of your own return and keep the supporting documents.\nWhat you need:\n  - a signed statement from a medical practitioner describing the impairment, when it began and its expected duration, if CRA asks for it\n  - records showing the support you provide.\nPractical tips:\n  - this is claimed by the supporter, so it does not reduce the tax of the person with the disability\n  - which line to use depends on the relationship and on other credits already claimed for that person, so read CRA's table before filing\n  - the amounts are indexed and change each tax year, so do not rely on a figure you saw in a previous year."
  },
  "aish": {
  ...
  "ab-grant-disability": {
    ...
    "text": "What it is: A provincial grant for approved disability-related services and equipment. The Canada Student Grant for Services and Equipment – Students with Disabilities is allocated first; Alberta funding may apply only when that federal grant is unavailable or leaves approved costs uncovered. The Alberta maximum is [amount — see the guide] per loan year and cannot exceed approved costs.\nHow to apply:\n  1. Apply for financial assistance through Alberta Student Aid and request disability-related services or equipment.\n  2. For each new financial-assistance application where disability-related services or equipment are requested, complete the current Schedule 4 with the services and equipment requested and their current costs.\n  3. Attach quotes or estimates for every requested cost and include documentation describing why the items are needed if Alberta Student Aid does not already have it.\n  4. Submit receipts by the end of the study period and return any unused or undocumented funding to avoid an overpayment.\nWhat you need:\n  - An approved Schedule 4 for the current financial-assistance application\n  - Current quotes or estimates showing the requested service and equipment costs\n  - Documentation of a permanent disability or persistent or prolonged disability\n  - Documentation describing the disability-related need for each service or item, if not previously provided\n  - Receipts for funded services and equipment, due by the end of the study period\nPractical tips:\n  - Disability-type verification already on file may sometimes be reusable, but every new application requesting services or equipment still needs a current Schedule 4 cost request and quotes or estimates.\n  - Ask your school's disability services office to help describe the need and prepare Schedule 4, but confirm all requested costs are current.\n  - Keep copies of approvals, quotes, invoices and receipts. Unused funding, or funding without required receipts, must be returned or becomes an overpayment.\nHow long it takes (verified — you may state this): Assessed with your Alberta student aid application.",
  ...
  "child-health-benefit": {
    ...
    "text": "What it is: No-premium prescription, dental, optical and other eligible health coverage for children [age limit — see the guide] in lower-income Alberta families. A child [age limit — see the guide] or 19 can qualify only while living at home and attending high school through grade 12, with declaration AEHB3654.\nHow to apply:\n  1. Check the income guidelines and confirm the whole family's Alberta residency, citizenship or permanent-resident status, and other government health coverage.\n  2. Complete the Alberta Child Health Benefit application.\n  3. For an eligible 18- or 19-year-old living at home and attending high school through grade 12, also submit Declaration of 18 and 19 Year Old Dependent AEHB3654: https://cfr.forms.gov.ab.ca/Form/AEHB3654\n  4. Submit the application with proof of income.\nWhat you need:\n  - Proof of family income\n  - Your children's Alberta Health Care numbers\n  - Declaration AEHB3654 for an eligible 18- or 19-year-old dependent\nPractical tips:\n  - Income Support, AISH, the Child and Youth Support Program, and Non-Insured Health Benefits for First Nations and Inuit are excluded government health-benefit coverage.\n  - Private or other health insurance is not an exclusion. Use it first; ACHB may cover remaining eligible costs.\n  - Use the Canadian Dental Care Plan first; ACHB may cover remaining eligible dental costs.\nHow long it takes (verified — you may state this): A few weeks to process.",
    "phone": "Alberta Supports: 1-877-644-9992"
  },
  "ramp": {
    ...
    "text": "What it is: A provincial grant for permanent modifications that let you enter and move within your own living space. RAMP pays up to [amount — see the guide] per person each benefit year, which runs April 1 to March 31, and up to [amount — see the guide] per person within 10 years. You qualify by one of three routes: you use a wheelchair at any age; you are [age limit — see the guide] and use a 4-wheel walker on an ongoing basis; or you live with multiple sclerosis, muscular dystrophy, ALS, COPD, Parkinson's disease, Alzheimer's disease, spina bifida, a spinal cord injury, or a non-recovering stroke. You must be a Canadian citizen or permanent resident who has lived in Alberta for 90 continuous days, and your family income must be within the RAMP table — from [amount — see the guide] for a single adult to [amount — see the guide] for a couple with five children, plus [amount — see the guide] when a child permanently uses a wheelchair. Alberta notes that exceptions may apply when income is within [amount — see the guide] of the threshold.\nHow to apply:\n  1. Read the RAMP Guidelines and Criteria document before starting; Alberta says incomplete applications will not be processed.\n  2. Complete the RAMP Application Checklist, the RAMP Application Form and the RAMP Modification Recommendation Form.\n  3. Add any conditional forms that apply to you — Landlord Agreement, Band Council Resolution, Sponsor Income Verification, or Disclosure Consent.\n  4. Mail the complete package to RAMP, Assisted Living and Social Services, PO Box 808 Edmonton Main, Edmonton, AB T5J 2L4, or use the email address on the RAMP page.\nWhat you need:\n  - RAMP Application Checklist, Application Form and Modification Recommendation Form\n  - Proof of Canadian citizenship or permanent residence, and of 90 continuous days in Alberta\n  - Family income verification for your household size\n  - Any conditional form that applies: Landlord Agreement, Band Council Resolution, Sponsor Income Verification, or Disclosure Consent\nPractical tips:\n  - Tell RAMP if you are awaiting hospital discharge or are in palliative care — Alberta prioritises those applications.\n  - Modifications must be permanent. RAMP reviews requests for temporary modifications case by case.\n  - Work must be completed within 90 days of approval unless RAMP authorises more time.\n  - There is no appeal process. If you are refused you can reapply with updated information.\n  - Alberta has said the Guidelines and Criteria document and the Application Form are being updated — use the current forms on the RAMP page until the new ones appear.\nHow long it takes (verified — you may state this): Alberta says you should receive a decision letter in the mail within 30 days of applying."
  },
  "parking-placard": {
  ...
  "calgary-fair-entry": {
    ...
    "text": "What it is: A single City of Calgary application ('Fair Entry') that qualifies you for several low-income discounts at once — the sliding-scale monthly transit pass and lower-cost recreation admission and programs. Calgary does not publish a fixed percentage for recreation fee assistance.\nHow to apply:\n  1. Gather proof of income for your household.\n  2. Apply online through Fair Entry (or in person).\n  3. Once approved, buy the low-income transit pass and use your Fee Assistance card for recreation.\nWhat you need:\n  - Proof of income (e.g. tax assessment or benefit statements)\n  - Calgary address\nPractical tips:\n  - One approval covers transit AND recreation — you don't apply separately.\n  - The transit pass price slides with income across three 2026 bands: [amount — see the guide], [amount — see the guide] or [amount — see the guide] per month.\nHow long it takes (verified — you may state this): Usually processed within a couple of weeks.",
  ...
  "local-supports": {
    ...
    "text": "What it is: Beyond the biggest cities, many municipalities offer their own low-income or disability discounts on transit and recreation — but they're all named and delivered differently. [phone — see the guide] is a free, confidential, 24/7 service that connects you to the specific programs in your community.\nHow to apply:\n  1. Visit your provincial [phone — see the guide] site, or simply dial [phone — see the guide] from any phone.\n  2. Tell them your town and what you need (transit, recreation, financial help).\n  3. They'll point you to the exact local programs and how to apply.\nWhat you need:\n  - Your city or town name\n  - A rough idea of your household income\nPractical tips:\n  - Dialing [phone — see the guide] is free and available 24/7 in many languages.\n  - Also search your town's own website for 'recreation fee assistance' or 'low-income transit pass'.\nHow long it takes (verified — you may state this): Immediate — it's an information service.",
    "phone": "Dial 2-1-1"
  },
  "bc-pwd-designation": {
  ...
  "bc-msp-supplementary-benefits": {
    ...
    "text": "What it is: MSP contributes [amount — see the guide] per visit for a combined annual limit of 10 visits each calendar year, for acupuncture, chiropractic, massage therapy, naturopathy, physical therapy and non-surgical podiatry from approved providers. Eligibility is assessed from last year's net income as confirmed by the Canada Revenue Agency, or the combined net income of you and your spouse, less certain deductions; the figure that remains is called adjusted net income, and if it is less than [amount — see the guide] your family may qualify. People enroled with MSP through the At Home Program, and people enroled with MSP as Mental Health Clients, are also eligible. Applying is free, and once approved you generally do not need to reapply while you stay eligible for MSP, because income is re-verified each year automatically. MSP does not cover supplementary benefit services received outside the province.\nHow to apply:\n  1. Make sure MSP enrolment is complete for you and your spouse if you have one\n  2. Complete the BC Application for Health and Drug Coverage, which applies for MSP enrolment, Supplementary Benefits and Fair PharmaCare on one form\n  3. Give CRA permission on the application to release your Notice of Assessment so your income can be verified\n  4. If you are newly eligible for MSP, book a B.C. driver licensing office appointment to get your Photo BC Services Card\nWhat you need:\n  - The BC Application for Health and Drug Coverage\n  - Your and your spouse's CRA Notice of Assessment information, which you authorise on the application rather than sending\n  - Your Personal Health Number if you already have one\nPractical tips:\n  - The 10 visits are a combined limit across all six service types, so they run down together\n  - [amount — see the guide] is a contribution and not the full fee, so ask the practitioner what you will owe before booking\n  - Keep filing your taxes every year, because eligibility is re-verified automatically from your CRA return and lapses if you stop filing\n  - Tell MSP if you marry or start living in a marriage-like relationship, because that changes how your income is assessed\n  - If your children are [age limit — see the guide] this also opens the Healthy Kids Program for dental and optical"
  },
  ...
  "bc-pharmacare-plan-g": {
    ...
    "text": "What it is: Plan G pays [percentage — see the guide] of eligible costs for certain psychiatric medications, for B.C. residents of any age who have both clinical and financial need. The province describes the financial test as an annual income lower than [amount — see the guide]. Eligibility is confirmed by your physician or nurse practitioner together with your local mental health and substance use location, or the Child and Youth Mental Health team, and the prescriber then submits the Application for PharmaCare Plan G form for you. Coverage runs for up to one year and must be renewed if you still need it; the province advises knowing your renewal date and seeing a healthcare provider about a month ahead to submit the new application.\nHow to apply:\n  1. Tell your physician or nurse practitioner that you have both clinical and financial need and ask about Plan G\n  2. They confirm eligibility with your local mental health and substance use location, or the Child and Youth Mental Health team\n  3. The prescriber submits the Application for PharmaCare Plan G form on your behalf\n  4. Write down your renewal date and book an appointment about a month before it to submit a new application\nWhat you need:\n  - Nothing for you to submit — your prescriber completes and sends the Application for PharmaCare Plan G form\n  - Bring anything your prescriber asks for to show income if they need it\nPractical tips:\n  - The renewal is the thing that catches people out, because coverage simply stops after a year, so put the date somewhere you will see it and go in a month early\n  - The plan covers certain psychiatric medications and not every drug, so ask your prescriber or pharmacist whether the specific medication is on Plan G before you rely on it\n  - Substance use is covered by the same route, since eligibility is confirmed through the local mental health and substance use location\n  - Plan G's [amount — see the guide] test is on annual income, which is worded differently from the adjusted net income test used for MSP Supplementary Benefits — qualifying for one does not automatically mean qualifying for the other"
  },
  "bc-pharmacare-plan-p": {
    ...
    "text": "What it is: Plan P covers [percentage — see the guide] of eligible costs for medications used in palliative care that appear on the Plan P formulary. It is for B.C. residents of any age who have reached the end stage of a life-threatening disease or illness and who wish to receive palliative care at home, and \"home\" is read broadly: the person's own home, living with family or friends, a supportive or assisted living residence, or a hospice unit at a long-term care facility such as a community hospice bed that is not covered under PharmaCare Plan B. Medications are only part of it — eligible patients can also receive medical supplies and equipment through their local health authority. A physician or nurse practitioner submits the registration form to PharmaCare, and the single form notifies both PharmaCare and the health authority that the patient is eligible.\nHow to apply:\n  1. Tell the doctor or nurse practitioner that palliative care at home is what the patient wants, and ask them to register the patient for BC Palliative Care Benefits\n  2. Ask the same clinician, or the local health authority, about the medical supplies and equipment that come with eligibility, since those are arranged separately from the medications\n  3. Ask for the BC Palliative Care Benefits patient information sheet, which is available in multiple languages\nWhat you need:\n  - Nothing for the patient or family to submit — the registration form is completed and sent by the physician or nurse practitioner\nPractical tips:\n  - The medications are covered at [percentage — see the guide] when they are on the Plan P formulary, so ask the pharmacist to check the formulary if something is not covered\n  - Supplies and equipment come through the local health authority rather than PharmaCare, and are worth asking about separately\n  - A community hospice bed counts as home for this plan, as long as it is not already covered under PharmaCare Plan B\n  - Registration in Plan P is also one of the prescribed routes to B.C.'s Persons with Disabilities designation, which can matter if disability assistance is being applied for at the same time"
  },
  "bc-fnha-health-benefits": {
    ...
    "text": "What it is: The FNHA Health Benefits program includes dental, medical supplies and equipment, medical transportation, mental health, pharmacy and vision care. The pharmacy part is PharmaCare Plan W, which covers [percentage — see the guide] of eligible prescription costs, certain medical supplies, certain over-the-counter drugs, some natural health products, and pharmacy services. Covered medical supplies include diabetes supplies such as test strips, lancets and alcohol wipes, contraceptives, and ostomy supplies. Plan W requires active MSP coverage together with registered Indian status under the Indian Act, or being a child [age limit — see the guide] years old with at least one parent who is a registered Indian under the Indian Act.\nHow to apply:\n  1. Have your status number ready\n  2. Call FNHA Health Benefits at [phone — see the guide] to enrol, Monday to Friday, 8 a.m. to 4:30 p.m., excluding weekends and statutory holidays\n  3. If you are registering for the first time, you may also need to complete the Pacific Blue Cross Enrollment Application for Group Benefits and the Medical Services Plan Application for Enrollment\n  4. Email the completed forms to HealthBenefits@fnha.ca\n  5. To enrol a child, register the birth with B.C. within three months so the child gets a Personal Health Number, and register the child for Indian Status with Indigenous Services Canada\nWhat you need:\n  - Status number\n  - Personal Health Number\n  - Pacific Blue Cross Enrollment Application for Group Benefits, for first-time registration\n  - Medical Services Plan Application for Enrollment, for first-time registration\nPractical tips:\n  - A child with a Personal Health Number can be covered under a parent's account until [age limit — see the guide] while waiting for their own status number; once the child has their own status number, call [phone — see the guide] to enrol them separately\n  - Enrolment is done over the phone rather than through an online form, so plan the call inside the weekday office hours\n  - If you already have health insurance from the federal government, or through a First Nations self-government agreement with Canada, you are not eligible for this program"
  },
  "bc-healthy-kids": {
  ...
  "bc-at-home-medical": {
    ...
    "text": "What it is: Medical Benefits can cover approved equipment, supplies, therapies, dental, optical, medical travel, and prescription drugs and designated medical supplies at [percentage — see the guide] through PharmaCare Plan F. The program must approve many items before they are bought, and coverage ends on the last day of the month the child [age limit — see the guide].\nHow to apply:\n  1. Complete the At Home Program application with a doctor or nurse practitioner\n  2. Attach the requested identification and functional assessments; children [age limit — see the guide] may be asked for extra supporting information\n  3. Send the application to the regional At Home Program office listed by the province\n  4. Take part in the in-home assessment of eating, dressing, toileting and washing if one is required\n  5. Wait for the written decision, then work with the CYSN worker or Medical Benefits branch before purchasing covered equipment or services\nWhat you need:\n  - Completed At Home Program application with parent and medical-professional sections\n  - Identification for the child and parent or guardian\n  - Child's Personal Health Number and proof of active MSP\n  - Requested functional assessments such as Vineland-3, PEDI-CAT or GMFCS, when applicable\nPractical tips:\n  - Families in current pilot areas use a different Medical Benefits application route; check the official page for your community\n  - Do not buy equipment, dental, optical or travel first when pre-approval is required\n  - Start adult PWD planning about six months before the child's [age limit — see the guide]\n  - PharmaCare Plan F is not a separate application. Once your child is receiving full benefits or medical benefits through the At Home Program, MCFD sends their information to PharmaCare and the drug coverage follows automatically.\n  - Plan F covers designated medical supplies at [percentage — see the guide] as well as prescription drugs, so ask the At Home Program or your pharmacist whether a supply you are paying for is on the designated list before you keep buying it yourself.\nHow long it takes (verified — you may state this): Assessment and regional review follow a complete application; no guaranteed timeline is published",
  ...
  "bc-additional-home-owner-grant": {
    "name": "B.C. Home Owner Grant — additional grant for people with disabilities",
    "keys": [
      "bc-additional-home-owner-grant",
      "bc additional home owner grant",
      "b.c. home owner grant — additional grant for people with disabilities"
    ],
    "text": "What it is: The home owner grant lowers the property tax on your principal residence. The regular grant for 2026 is up to [amount — see the guide] in the Capital, Fraser Valley and Metro Vancouver regional districts and up to [amount — see the guide] elsewhere. If you are a person with a disability, or you live with a relative who has one, the additional grant raises that to up to [amount — see the guide] and up to [amount — see the guide]. The 2026 grant threshold is an assessed value of [amount — see the guide] and the grant is reduced by [amount — see the guide] for each [amount — see the guide] of assessed value above it. A health professional must certify on Form B (FIN 74) that the person has a severe mental or physical impairment likely to continue for at least two years. If your assessed value is above the threshold, a separate low income grant supplement may apply when adjusted net income is [amount — see the guide] or less.\nHow to apply:\n  1. read the eligibility page for people with disabilities\n  2. if you qualify through disability assistance, no health professional form is needed and you may optionally file Form FIN 81, Home Owner Grant Consent for Release of Information\n  3. if you qualify on the daily-living or structural-modification route, have a health professional complete Form B (FIN 74), Certificate of Health Professional and Property Owner, with your first application\n  4. apply for the grant each year, through the province rather than your municipality\nWhat you need:\n  - Form B (FIN 74), Certificate of Health Professional and Property Owner, for the daily-living or structural-modification route on a first application\n  - optionally Form FIN 81, Home Owner Grant Consent for Release of Information\n  - your property tax notice\nPractical tips:\n  - you must apply every year, the grant is not automatic\n  - you must still pay at least [amount — see the guide] in property taxes\n  - the higher northern and rural amount ends January 1, 2027",
  ...
  "bc-raha": {
    ...
    "keys": [
      "bc-raha",
      "bc raha",
      "b.c. rebate for accessible home adaptations"
    ],
    "text": "What it is: BC RAHA provides rebates so people can adapt their home for independent living. The lifetime maximum is [amount — see the guide] per household, and individual adaptations have their own caps set out in BC Housing.s Maximum Rebate Schedule. Applications are taken first-come, first-served until the funding for the year runs out, and the funding renews on April 1 each year. BC Housing aims to assess a completed application within 8 weeks, and pays within 3 weeks of receiving the final documents once the work is done. If you rent, the unit must be a legal, self-contained home with its own full kitchen and bathroom, and the tenant must be living independently rather than in assisted living; tenants apply jointly with their landlord, and members of a housing co-operative use the landlord-and-tenant route.\nHow to apply:\n  1. check the property and adaptation eligibility pages, and use the BC RAHA Calculator to see whether you might qualify\n  2. get an occupational therapist or physical therapist assessment if your adaptation needs one\n  3. submit the BC RAHA Homeowner Application, or the Landlord and Tenant Application if you rent, with the documents it lists\n  4. wait for written approval from BC Housing BEFORE any work starts, then complete the work within 180 days\nWhat you need:\n  - the BC RAHA Homeowner Application, or the Landlord and Tenant Application if you rent\n  - an occupational therapist or physical therapist assessment where the adaptation requires one\n  - contractor quotes\n  - proof of household income and assets as listed in the application\nPractical tips:\n  - do not start work before written approval, because anything finished first is not eligible\n  - funding renews April 1 and applications are first-come first-served, so apply early in the year\n  - you have 180 days from written approval to finish\n  - the [amount — see the guide] is a lifetime maximum for the household, not per adaptation\n  - BC Housing publishes an eligibility calculator at bcrahacalculator.bchousing.org — it takes a few minutes and tells you whether you are likely to qualify before you fill in the full application.\nHow long it takes (verified — you may state this): BC Housing aims to assess completed applications within 8 weeks, and pays within 3 weeks after the work is done and documents are received.",
