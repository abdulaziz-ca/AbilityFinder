...
const BENEFITS = [
  ...
  },
  {
    ...
    "note": "B.C. confirms SAET stays available until March 31, 2027, or until the child transitions to the new BC Children and Youth Disability Benefit, whichever comes first, and all SAET authorizations are being updated to align with that end date. New families are told to keep using the current pathways for now. The new Disability Benefit begins April 1, 2027, and therapies remain an approved use of it. Ask AHP Medical Benefits which stream applies to your child.",
